        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand"><?php echo $set->site_name; ?></a>
...
foreach ($page->navbar as $activation_code => $v) {
...
if($user->data->banned) {
    ...
    $_banned = $user->getBan();
    if($_banned)
    $options->error("You were banned by <a href='profile.php?u=$_banned->by'>".$user->showName($_banned->by)."</a> for `<i>".$options->html($_banned->reason)."</i>`.
...
if($user->islg() && $set->email_validation && ($user->data->validated != 1)) {
    $options->fError("Your account is not yet activated! The security-code sending functionality is still under development! Please, ask the site Administrator for the 6 digit security-code for your account activation and submit it <a href='activate.php'>here</a>");
